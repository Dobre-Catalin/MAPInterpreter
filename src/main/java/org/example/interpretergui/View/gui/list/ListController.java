package org.example.interpretergui.View.gui.list;
...
public class ListController {
    ...
    public void initialize() {
        ...
        RepositoryInterface repoExam1 = new MemoryRepository(prgExam1, new StringValue("log.txt"));
        ...
        Controller ctrlExam1 = new Controller(repoExam1, new BoolValue(true));
        ...
        menu.addCommand(new RunExample("7", exam1.toString(), ctrlExam1));

        StatementInterface[] statementProgs = new StatementInterface[]{prog7, prog8, prog9, prog10, ex7, statement10, exam1};
        ...
        displayButton.setOnAction(actionEvent -> {
            ...
            if (index < 0)
                return;
            ProgramState state = new ProgramState((StackInterface<StatementInterface>) statementProgs[index]);
