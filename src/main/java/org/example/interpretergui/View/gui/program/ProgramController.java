package org.example.interpretergui.View.gui.program;
...
public class ProgramController {
    ...
    public void initialize() {
        ...
        oneStep.setOnAction(actionEvent -> {
            ...
            try {
                controller.oneStepForAll(controller.getProgramStates().getList());
                populate();
    ...
    private void populateProgramStateIdentifiers() {
        ListInterface<ProgramState> programStates = controller.getProgramStates();
        ///var idList = programStates.stream().map(ps -> ps.getIDs()).collect(Collectors.toList());
